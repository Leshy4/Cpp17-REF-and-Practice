#include "pch.h"  // Ex6_07.cpp	// Using smart pointers
#include <iostream>
#include <iomanip>
#include <memory> // For smart pointers
#include <vector> // For vector container
#include <cctype> // For toupper()
void Printer() { std::cout << "\n\t\t\tThis shows the size of Printing this message passed through a function.\n"; };
int main()
{
	...
	std::cout << "\n\t\t\tThis shows the size of Printing this message\n";
	std::cout << "\n\t\t\tRegular Printed message size = "
		<< sizeof(std::cout << "\n\t\tPrinted size = \n");
